...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "BrandedUseTGxBot")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "BrandedUseTGxBot")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/BrandedUseTGxBot")
    ...
    # please reopen
    # https://github.com/WCGKING/MyTelegramOrgRoBot/issues/3
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/BrandedUseTGxBot"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "❤️ @BRANDRD_BOT")
